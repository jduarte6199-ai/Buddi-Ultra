...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "Common Cactus (Cross None)")
    ...
    // MARK: Shelf
    static let shelf = Key<Bool>("shelf", default: true)
    ...
    // MARK: Buddy
    static let buddySpeciesOverride = Key<String?>("buddySpeciesOverride", default: nil)
